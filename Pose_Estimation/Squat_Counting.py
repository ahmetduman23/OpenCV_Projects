...
def findAngel(img, p1, p2, p3, lmList, draw=True):
...
cap = cv2.VideoCapture("Pose_Estimation\Squat.mov")
...
while True:
    ...
    if len(lmList) != 0:
        ...
        angle = findAngel(img ,23 , 25, 27, lmList)
        ...
        cv2.putText(img, str(int(count)), (45,105), cv2.FONT_HERSHEY_PLAIN, 5, (255,0,0), 5)
